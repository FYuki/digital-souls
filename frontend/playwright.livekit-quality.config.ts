...
if (!['integration-voice', 'integration-irodori', 'integration-irodori-ollama-candidate'].includes(measurementProfile)
  || (measurementProfile.startsWith('integration-irodori') && pcmObserver)
  || (measurementProfile === 'integration-irodori-ollama-candidate' && faultBridge)) {
