...
describe('resolved profile reader', () => {
  ...
  test.each(['integration-irodori-ollama-candidate', 'integration-irodori-cuda-graph', 'integration-irodori-cuda-graph-pcm', 'integration-irodori-cuda-graph-fault', 'integration-irodori-memory-reference'])(
