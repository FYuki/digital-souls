...
class ContainerResourceSampler:
    ...
    def sample(self) -> dict[str, Any]:
        ...
        try:
            ...
            if (not isinstance(profile, dict) or profile.get("effectiveProfile") not in {"integration-voice", "integration-voice-fault", "integration-irodori-fault", "integration-voice-pcm", "integration-irodori", "integration-irodori-ollama-candidate", "integration-irodori-cuda-graph", "integration-irodori-memory-reference"}
