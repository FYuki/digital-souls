...
@pytest.mark.parametrize("profile", ["integration-voice-fault", "integration-irodori", "integration-irodori-ollama-candidate", "integration-irodori-cuda-graph", "integration-irodori-fault", "integration-irodori-cuda-graph-fault", "integration-irodori-memory-reference"])
