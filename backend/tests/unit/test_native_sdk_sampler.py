...
@pytest.mark.parametrize("profile", ["integration-voice-fault", "integration-irodori", "integration-irodori-ollama-candidate", "integration-irodori-cuda-graph", "integration-irodori-memory-reference", "integration-irodori-fault"])
