...
@pytest.mark.parametrize("profile_name", ["integration-voice", "integration-voice-fault", "integration-voice-pcm", "integration-irodori", "integration-irodori-ollama-candidate", "integration-irodori-fault"])
