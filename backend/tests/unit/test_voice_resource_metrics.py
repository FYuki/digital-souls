...
@pytest.mark.parametrize("profile_name", ["integration-voice", "integration-voice-fault", "integration-voice-pcm", "integration-irodori-cuda-graph-pcm", "integration-irodori", "integration-irodori-ollama-candidate", "integration-irodori-cuda-graph", "integration-irodori-fault", "integration-irodori-cuda-graph-fault", "integration-irodori-memory-reference"])
